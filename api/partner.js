    ...
    if (action === "invite") {
      ...
      await sendMail({
        ...
        html: shell(
          ...
          `사랑에도 기술이 있습니다. PLove는 Practice Love의 합성어로, 알고 있지만 표현하지 못했던 마음을 AI와 함께 매일 하나씩 실천하는 서비스입니다. 파트너 구독권을 수락하면, 아래의 클래스는 서로 기록을 보면서 함께 학습할 수 있어요. 물론, 나중에 설정은 언제든지 변경이 가능해요.` + list,
